...
export function Footer() {
  ...
  return (
    <footer className="border-border/50 bg-card/30 border-t backdrop-blur-sm">
      <div className="mx-auto max-w-[1400px] px-6 py-16">
        <div className="mb-12 flex flex-col gap-8 md:flex-row md:justify-between">
          ...
          <div className="col-span-2 md:col-span-1">
            ...
            <p className="text-muted-foreground mb-4 w-96 text-sm leading-relaxed">
              Create stunning designs with AI-powered tools. Professional
              results, no experience needed.
            </p>
          </div>
          ...
          <div className="flex flex-col items-start justify-center gap-4">
            ...
            <p className="text-muted-foreground text-sm">
              © {new Date().getFullYear()} Arture. All rights reserved.
            </p>
          </div>
        </div>
      </div>
